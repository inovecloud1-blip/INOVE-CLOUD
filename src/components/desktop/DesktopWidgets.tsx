    ...
    switch (id) {
      ...
      case 'apps':
        return {
          ...
          desc: 'Grade de apps fixados no Desktop estilo InoveCloud Liquid Glass',
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pb-2 mb-2 border-b border-white/10">
                        <div className="flex items-center space-x-2 text-cyan-400">
                          ...
                          <span className="text-[11px] font-bold uppercase tracking-wider">Run any OS in InoveCloud</span>
                        </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Escolha o que exibir ou tirar da Tela Inicial InoveCloud OS Liquid Glass
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                <button
                  onClick={() => {
                    ...
                    showToast('Modo InoveCloud Glass Aplicado.');
                  }}
                ...
                >
                  <div className="font-bold text-white group-hover:text-purple-300">InoveCloud Clean</div>
